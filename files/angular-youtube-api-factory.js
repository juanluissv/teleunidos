...
angular.module("jtt_youtube", [])
    .factory('youtubeFactory', ['$http', '$log', 'youtubeSearchDataService', function ($http, $log, youtubeSearchDataService) {
    ...
    .service('youtubeSearchDataService', function ($log) {
